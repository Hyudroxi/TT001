 ...
 * @author lfrma
 */
public class Veterinários extends javax.swing.JFrame {

    /**
     * Creates new form Veterinários
     */
    public Veterinários() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Veterinários.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Veterinários().setVisible(true);
            }
        });
    }
